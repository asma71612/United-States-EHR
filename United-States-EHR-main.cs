...
namespace Bme121
{
    ...
    static class Program
    {
        static void Main( )
        {
            ...
            // makes sures that the file is closed when block is done running 
            using FileStream file = new FileStream ( path, mode, access );

            // create a StreamReader to view file as lines of text and count number of lines and characters in the file 
            using StreamReader reader = new StreamReader ( file );
            reader.ReadLine ( );
            
            // make a list of EhrKpiRecord objects
            ...
            while ( !reader.EndOfStream )
            {
                ...
                // trims out the quotation marks so they're not displayed
                ...
                // if statements to assign null to NA int values 
                ...
                EhrKpiRecord records = new EhrKpiRecord ( state, stateCode, countyName, stateFips, 
                    countyFips, fips, period, numProvidersSignedUp, numPrimaryCareProvidersSignedUp, 
                    numProvidersGoLive, numPrimaryCareProvidersGoLive, numProvidersMeaningfulUse, 
                    numPrimaryCareProvidersMeaningfulUse );
                    
                ehrKpiRecords.Add ( records );
            }
